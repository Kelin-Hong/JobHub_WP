...
{
    [Table]
    public class JobTable : INotifyPropertyChanging, INotifyPropertyChanged
    {
            private int id;
         ...
         private string job_companyname;
          ...
          private bool job_collection;
            [Column]
            public bool Job_IsCollection
            {
                get { return job_collection; }
                set
                {
                    if (job_collection != value)
                    {
                        OnPropertyChanging("Job_IsCollection");
                        job_collection = value;
                        OnPropertyChanged("Job_IsCollection");
                    }
                }
            }
